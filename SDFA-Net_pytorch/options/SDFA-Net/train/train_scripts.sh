# train SDFA-Net with UASOL at stage1
CUDA_VISIBLE_DEVICES=0 python\
 train_dist.py\
 --name SDFA-Net-UASOL\
 --exp_opts options/SDFA-Net/train/uasol_train_stage1.yaml\
 --batch_size 12\
 --epoch 25\
 --visual_freq 2000\
 --save_freq 5

# train SDFA-Net with UASOL at stage2
CUDA_VISIBLE_DEVICES=0 python\
 train_dist.py\
 --name SDFA-Net-UASOL\
 --exp_opts options/SDFA-Net/train/uasol_train_stage2.yaml\
 --batch_size 12\
 --start_epoch 25\
 --visual_freq 2000\
 --save_freq 5\
...
# train SDFA-Net at stage1 on KITTI
CUDA_VISIBLE_DEVICES=0 python\
 train_dist.py\
...
# train SDFA-Net at stage2 on KITTI
CUDA_VISIBLE_DEVICES=0 python\
 train_dist.py\
